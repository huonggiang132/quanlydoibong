...
{
    public partial class FrmBC_CTnhieuBT : Form
    {
        DataTable cauthu;
        public FrmBC_CTnhieuBT()
        {
            InitializeComponent();
        }
        ...
        {
            string sql;
            sql = "select top(3) *from cauthu " +
                        "order by sobanthang DESC"; 
            cauthu = DAO.GetDataToTable(sql);
            GridViewBC_CTnhieuBT.DataSource = cauthu;
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["E2:H2"].Value = "Báo cáo 3 cầu thủ ghi được nhiểu bàn thắng nhất";
            ...
            exRange.Range["C4:C4"].Value = "Tên cầu thủ";
            exRange.Range["D4:D4"].Value = "Mã đội";
            exRange.Range["E4:E4"].Value = "Vị trí";

            exRange.Range["F4:F4"].Value = "Ngày sinh";
            exRange.Range["G4:G4"].Value = "Số áo";
            exRange.Range["H4:H4"].Value = "Số thẻ vàng";
            exRange.Range["I4:I4"].Value = "Số thẻ đỏ";
            exRange.Range["J4:J4"].Value = " Số bàn thắng";
            exRange.Range["K4:K4"].Value = "Mã quốc tịch";
            exRange.Range["L4:L4"].Value = "Số lần ra sân";
            //exRange.Range["M4:M4"].Value = "Ảnh";
